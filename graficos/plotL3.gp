...
set ylabel  "L3"
set title   "L3 funções MatVet e MatMat"
set terminal qt 1 title "L3 funções MatVet e MatMat"
set datafile separator ","
plot 'L3.dat' using 1:2 title "<Matriz x Vetor Sem Otimização>" with linespoints, \
