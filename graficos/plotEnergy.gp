...
set title   "Energia funções MatVet e MatMat"
set terminal qt 1 title "Energia funções MatVet e MatMat"
set datafile separator ","
plot 'ENERGY.dat' using 1:2 title "<Matriz x Vetor Sem Otimização>" with linespoints, \
