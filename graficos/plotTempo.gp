...
set title   "Tempo de execução funções MatVet e MatMat"
set terminal qt 1 title "Tempo de execução funções MatVet e MatMat"
set datafile separator ","
plot 'tempoExecucao.dat' using 1:2 title "<Matriz x Vetor Sem Otimização>" with linespoints, \
